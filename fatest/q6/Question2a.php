...
<body>
    <form action="Question2b.php" method="post" onsubmit="return validateForm()">
        ...
        <label>Options :</label>
        <input type="radio" id="self_delivery" name="options" value="Self-Delivery" oninvalid="this.setCustomValidity('Please Choose Any Options')" oninput="this.setCustomValidity('')" required> Self-Delivery
